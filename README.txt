...
type parameters
	...
	type GenericType<T1, T2>
		+prop text String // publicly readable, not writable
		+prop- count Integer // publicly readable, privately writable

	getTuple(i Int, s String) => <i, s>
